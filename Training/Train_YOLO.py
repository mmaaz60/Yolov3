...
anchors_path = os.path.join(keras_path, 'model_data', 'yolo-tiny_anchors.txt')
weights_path = os.path.join(keras_path, 'yolo-tiny.h5')
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--is_tiny", default=True, action="store_true",
