...
detector_script = os.path.join(os.path.dirname(os.path.abspath(__file__)),'Inference','Detector.py')
...
anchors = os.path.join(root_folder,'Training','src','keras_yolo3','model_data','yolo_anchors.txt')
