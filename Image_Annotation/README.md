...
![New Project](/Image_Annotation/Screen_Recordings/New_Project.gif)
...
![New Project](/Image_Annotation/Screen_Recordings/Export_Settings.gif)
...
![New Project](/Image_Annotation/Screen_Recordings/Labeling.gif)
...
As a final step, convert the VoTT csv format to the YOLOv3 format. To do so, run the conversion script from within the [`TrainYourOwnYOLO/1_Image_Annotation`](/Image_Annotation/) folder:
...
Next, go to [`TrainYourOwnYOLO/2_Training`](/Training) to train your YOLOv3 detector.